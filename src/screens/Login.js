...
import { apiUrl, saveData } from '../utils/service/Api';
        ...
        <CustomPageCointainer edgeTop={"top"} style={styles.container}>
            ...
            <View style={styles.inputcontainer}>
                ...
                <View style={styles.inputbox1}>
                    ...
                    <TextInput maxLength={6}  secureTextEntry={visible} value={formState.inputValue['password']} onChangeText={(txt) => onChangeTextHandler("password", txt)} style={{ ...styles.phoneinput }} placeholder='MCFA PIN' />
            ...
            <View style={{ borderRadius: 12, width: "100%", marginTop: 20, }}>
                ...
                {/* <CustomButton  lable={"Sign In"} style={{ borderRadius: 12,padding:10 }} /> */}
            </View>
